...
public class AuthActivity extends AppCompatActivity {
    ...
    private void sendPasswordResetEmail(String email) {
        ...
        if (TextUtils.isEmpty(email)) {
            Toast.makeText(AuthActivity.this, "Por favor ingrese su correo electrónico", Toast.LENGTH_SHORT).show();
            return;
        }

        if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
            Toast.makeText(AuthActivity.this, "Ingrese un correo electrónico válido", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        auth.sendPasswordResetEmail(email)
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AuthActivity.this, "El correo no está registrado", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(AuthActivity.this, "Error al enviar el correo: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
/*
